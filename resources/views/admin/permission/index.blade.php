							...
							<div class="panel-body">
								<table
									...
									<tr>
										...
										<th>Tên Quyền</th>
										<th>Công việc được thực hiện</th>
										<th>Hành động</th>
									</tr>
									</thead>
									<tbody>
									@foreach ($data as $item)
										<tr>
											...
											<td class="form-group">
                                                @can('permission-edit')
												<a href="{{route('permission.edit',[$item->id])}}" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
                                                @endcan
                                                @can('permission-delete')
												<button type="button" class="btn btn-danger btn-delete" data-toggle="modal" data-target="#exampleModal" data-action="{{route('permission.destroy',[$item->id])}}">
