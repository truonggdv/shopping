                ...
                <div class="panel panel-blue panel-widget ">
                    <div class="row no-padding">
                        <div class="col-sm-3 col-lg-4 widget-left">
                            <span style="font-size: 50px;" class="glyphicon glyphicon-signal icon-50" aria-hidden="true"></span>
                        </div>
                        <div class="col-sm-9 col-lg-8 widget-right">
                            <div class="large">{{number_format($sum)}} đ</div>
                ...
                <div class="panel panel-teal panel-widget">
                    <div class="row no-padding">
                        ...
                        <div class="col-sm-9 col-lg-7 widget-right">
                            ...
                            <div class="text-muted">Đơn hàng trong tháng {{$month}}</div>
                        </div>
                    </div>
                </div>
            </div>
