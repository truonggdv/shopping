    ...
    <div class="container">
        <div class="row row-pb-md">
            ...
            <div class="col-md-4">
                ...
                <ul class="colorlib-footer-links">
                    <li>Địa chỉ: {{$itroduce->address}}</li>
                    <li><a href="tel://1234567920">Số Điện Thoại: {{$itroduce->phone}}</a></li>
                    <li><a href="mailto:info@yoursite.com">Email: {{$itroduce->contact}}</a></li>
                    <li><a href="#">Liên kết: {{$itroduce->instagram}}</a></li>
                </ul>
            </div>
        </div>
    </div>
